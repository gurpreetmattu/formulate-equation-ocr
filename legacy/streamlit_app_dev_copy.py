...
VOCAB_PATH = r"C:\Users\gurpr\final_six_months_project\dataset\vocab.json"
CHECKPOINT_PATH = r"C:\Users\gurpr\final_six_months_project\model_checkpoint\full_checkpoint.pt"
...
def predict_latex(image_tensor, encoder, seq_model, decoder, sos_token_id, eos_token_id, idx_to_token, max_len=MAX_LEN, beam_width=5, mode="greedy", device="cuda"):
...
def predict_and_convert_mathml(img_tensor, encoder, seq_model, decoder, sos_token_id, eos_token_id, idx_to_token, max_len=160, beam_width=5, device="cuda"):
...
if page == "Equation OCR":
    ...
    EXAMPLES_DIR = r"C:\Users\gurpr\final_six_months_project\examples"
